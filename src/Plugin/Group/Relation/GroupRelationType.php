...
class GroupRelationType extends PluginDefinition implements GroupRelationTypeInterface {
   ...
   * @var string|false
   */
  protected $sharedBundleClass = FALSE;
   ...
   * @var bool
   */
  protected $configEntityType = FALSE;
   ...
   * @var string
   */
  protected $prettyPathKey = 'content';
   ...
   * @var string|false
   */
  protected $adminPermission = FALSE;
