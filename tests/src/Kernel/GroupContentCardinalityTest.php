...
/**
 * Tests for the GroupContentCardinality constraint.
 *
 * @group group
 *
 * @coversDefaultClass \Drupal\group\Plugin\Validation\Constraint\GroupContentCardinalityValidator
 */
class GroupContentCardinalityTest extends GroupKernelTestBase {
