...
/**
 * Provides a test implementation with full operation support.
 */
class TestAccessControlWithFullOperationSupport implements AccessControlInterface {
  ...
  /**
   * Constructs a new TestAccessControlWithFullOperationSupport instance.
   *
   * @param \Drupal\Core\Access\AccessControlInterface $parent
   *   The parent access control object.
   * @param \Drupal\Core\Entity\EntityTypeManagerInterface $entity_type_manager
   *   The entity type manager service.
   * @param \Drupal\group\Entity\GroupRelationTypeManagerInterface $relation_type_manager
